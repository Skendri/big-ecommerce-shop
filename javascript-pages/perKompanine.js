...
const mbeshtjellesiKartaveGlobe = document.querySelector(
  "#mbeshtjellesi-kartaveGlobe",
);
...
const gjersiaKartesTePareGlobe =
  document.querySelector(".kartaMadheGlobe").offsetWidth;
const FemijetKartaveTeMedhaGlobe = [...kartatEMedhaGlobe.children];

// ------------------------------------------------- KARTAT E MEDHA SLIDER -------------------------------------------------------- /

let cardPerPamjeGlobe = Math.round(
  kartatEMedhaGlobe.offsetWidth / gjersiaKartesTePareGlobe,
);
...
// vido in page and there are script for full view of vido with keyboard
